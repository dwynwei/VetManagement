...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    private static final int cookieExpireInSeconds = 600;
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request,
    	...
    	CookieUtils.addCookie(response, OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME,CookieUtils.serialize(response), cookieExpireInSeconds);
    	...
    	if(StringUtils.isNotBlank(redirectAfterLogin)) {
    		CookieUtils.addCookie(response, REDIRECT_URI_PARAM_COOKIE_NAME, redirectAfterLogin, cookieExpireInSeconds);
    	}
    }
